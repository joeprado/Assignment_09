...
class Track():
    ...
    """
    # -- Constructor -- #
    def __init__(self, pos, ttl, lth):
        """Set position, title, and length a new track"""
    # -- Attributes -- #
        try: 
            self.__position = int(pos)
            self.__title = str(ttl)
            self.__length = str(lth)
    ...
    def position(self, new_position):
        if not str(new_position).isnumeric():
            print("The position should be an integer.")
        else: self.__position = new_position
    ...
    def title(self, new_title):
        if str(new_title).isnumeric():
            print("The title should not just be numbers.")
        else: self.__title = new_title
    ...
    def length(self, new_length):
        if ":" not in new_length:
            print("Incorrectly formatted length. Should be in format XX:XX.")
        else: self.__length = new_length
...
class CD:
    ...
    def __init__(self, cd_id: int, cd_title: str, cd_artist: str) -> None:
        ...
        try:
            ...
            self.__tracks = [] #Note: Creates attribute that is a list of track objects. 
        except Exception as e:
            raise Exception('Error setting initial values:\n' + str(e))
    ...
    def add_track(self, track: Track) -> None:
        ...
        """
        self.__tracks.append(track) #track come from user input
        self.__sort_tracks() #calls sort function below
